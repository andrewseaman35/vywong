                ...
                <div className="inner">
                    ...
                    <div className="tile-container">
                        <div className="row-group">
                            <NewTile side='left' project='mycite' title='MyCite' subtitle='Mobile and Web App' />
                            <NewTile side='right' project='ybvr_white_label' title='YBVR White Label' subtitle='Virtual Reality' />
                        </div>
                        <div className="row-group">
                            <NewTile side='left' project='traverse' title='Traverse' subtitle='Mobile iOS' />
                            <NewTile side='right' project='amma' title='AMMA' subtitle='Mobile Android' />
                        </div>
                    </div>
